        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="hidden" name="dpa_id" value="{{ $dokumenKontrak->dpa_id }}">
                    <select class="form-control" disabled>
                        <option>{{ $dokumenKontrak->dpa->kode_sub_kegiatan }}</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="dpa_id" value="{{ $dokumenKontrak->dpa_id }}">
                    <select class="form-control" disabled>
                        <option>{{ $dokumenKontrak->dpa->nama_sub_kegiatan }}</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="no_bukti">No Bukti:</label>
                    <input type="number" name="no_bukti" class="form-control" step="0.01" value="{{ $dokumenKontrak->no_bukti }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>

                <div class="form-group">
                    <label for="nama_kegiatan_transaksi">Nama Kegiatan Transaksi:</label>
                    <input type="text" name="nama_kegiatan_transaksi" class="form-control" value="{{ $dokumenKontrak->nama_kegiatan_transaksi }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>

                <div class="form-group">
                    <label for="tanggal_kontrak">Tanggal Kontrak:</label>
                    <input type="date" name="tanggal_kontrak" class="form-control" value="{{ $dokumenKontrak->tanggal_kontrak }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>

                <div class="form-group">
                    <label for="keterangan">Keterangan:</label>
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" @if(Auth::user()->hasRole('PPTK')) disabled @endif>{{ old('keterangan', $dokumenKontrak->keterangan) }}</textarea>
                </div>

                <div class="form-group">
                    <label for="upload_dokumen">Upload Dokumen</label>
                    @if($dokumenKontrak->upload_dokumen)
                        <p>Current file: {{ $dokumenKontrak->upload_dokumen }}</p>
                    @endif
            ...
            @else
                ...
                <div class="form-group">
                <label for="alasan">Alasan:</label><textarea name="alasan" class="form-control" value="{{ $dokumenKontrak->ppn }}" >{{ $dokumenKontrak->alasan }}</textarea>
                </div>
            @endif
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ppn" class="form-control" step="0.01" value="{{ $dokumenKontrak->ppn }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
                <div class="form-group">
                    <label for="pph">PPH:</label>
                    <input type="number" name="pph" class="form-control" step="0.01" value="{{ $dokumenKontrak->pph }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
                <div class="form-group">
                    <label for="potongan_lain">Potongan Lain:</label>
                    <input type="number" name="potongan_lain" class="form-control" step="0.01" value="{{ $dokumenKontrak->potongan_lain }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
                <div class="form-group">
                    <label for="jumlah_potongan">Jumlah Potongan:</label>
                    <input type="number" name="jumlah_potongan" class="form-control" step="0.01" value="{{ $dokumenKontrak->jumlah_potongan }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
                <div class="form-group">
                    <label for="jumlah_uang">Jumlah Uang:</label>
                    <input type="number" name="jumlah_uang" class="form-control" step="0.01" value="{{ $dokumenKontrak->jumlah_uang }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
                <div class="form-group">
                    <label for="jumlah_total">Jumlah Total:</label>
                    <input type="number" name="jumlah_total" class="form-control" step="0.01" value="{{ $dokumenKontrak->jumlah_total }}" @if(Auth::user()->hasRole('PPTK')) disabled @endif>
                </div>
            </div>
        </div>

        <button type="submit" class="btn btn-primary">Update Dokumen Kwitansi Data</button>
    </form>
</div>
