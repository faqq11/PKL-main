...
<div class="form-group">
    ...
    @if($baphs->upload_dokumen)
        <p>Current file: {{ $baphs->upload_dokumen }}</p>
    @endif
    ...
    @enderror
            ...
            @else
                ...
                <div class="form-group">
                <label for="alasan">Alasan:</label><textarea name="alasan" class="form-control">{{ $baphs->alasan }}</textarea>
                </div>
            @endif
