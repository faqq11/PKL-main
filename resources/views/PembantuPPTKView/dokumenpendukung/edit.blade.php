...
<div class="form-group">
    ...
    @if($dokumenPendukung->upload_dokumen)
        <p>Current file: {{ $dokumenPendukung->upload_dokumen }}</p>
    @endif
    ...
    @enderror
            ...
            @else
                ...
                <div class="form-group">
                <label for="alasan">Alasan:</label><textarea name="alasan" class="form-control">{{ $dokumenPendukung->alasan }}</textarea>
                </div>
            @endif
