...
@section('title', 'Berita Acara Pembayaran (BAP)')

@section('content')
<div class="container-fluid">
    <h1>Berita Acara Pembayaran (BAP)</h1>
        ...
        @endif
    <form action="{{ route('PembantuPPTKView.bap.store') }}" method="post" enctype="multipart/form-data">
        @csrf
